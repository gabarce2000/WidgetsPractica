...
class _BannerScrollingPageState extends State<BannerScrollingPage> {
              ...
              child: MaterialBanner(
                ...
                content: Column(
                  ...
                  children: [
                    ...
                    Text(
                        '¡Inscríbete en un entrenamiento de seis horas e invita a tus amigos!'),
                  ],
                ),
                actions: [
                  TextButton(
                    child: Text('ENTRAR', style: styleAction),
                    onPressed: join,
                  ),
                  TextButton(
                    child: Text('SALIR', style: styleAction),
  ...
  void join() => Scaffold.of(context)
    ...
    ..showSnackBar(SnackBar(content: Text('Hizo clic en Unirse')));
